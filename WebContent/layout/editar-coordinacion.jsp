...
<body>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
		...
		crd = dtc.recuperarCoordinacion(Integer.parseInt(idCoordinacion));
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Formulario de edición de departamento
                                    <div class="page-title-subheading">Edite los datos del departamento
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                ...
                                <form action="../SLCoordinacion?idcoordinacion=<%=idCoordinacion%>" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionCoordinacion" value="2">
                                <input hidden="true"  name="estado" value="<%=crd.getEstado()%>">
                                   <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label>Nombre del coordinacion</label>
                                            <input type="text" name="nombre" value="<%=crd.getNombre()%>"  class="form-control " style="width: 100%;"
                                                id="validationCustomUsername" placeholder="Escriba el nombre de la coordinación a registrar" required>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telefono" value="<%=crd.getTelefono()%>" class="form-control " style="width: 100%;"
                                                id="validationCustomUsername" placeholder="Escriba el teléfono de la coordinación" required>
                                            <div class="valid-feedback">
                                                Teléfono valido
                                            </div>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Carrera</label> 
                                            <select class="select2"   name="id_carrera" data-placeholder="Seleccione una Facultad" style="width: 100%;" required>
                                                <option value=""> Selecione al menos una</option>
                                                <%
												for (Carrera c : listCarrera) {
													if(c.getId_carrera()==crd.getId_carrera()){
												%>
												<option selected value="<%=c.getId_carrera()%>"><%=c.getNombre()%></option>
												<%
													}else{
												%>
