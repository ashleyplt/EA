                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                <div class="card-header">Crear plan de estudio
                                ...
                                <form action="../SLPlanDeEstudio" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionPlanDeEstudio" value="1">
