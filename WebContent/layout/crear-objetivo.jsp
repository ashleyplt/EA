            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Gestión de objetivos de asignatura
                                    <div class="page-title-subheading">Cree, edite y elimine nuevos objetivos de asignatura
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                <div class="card-header">Nuevo objetivo de asignatura
                                </div>
                                ...
                                <input hidden="true"  id="id_Syllabus" name="id_Syllabus" value="<%=idsyllabus%>">
                                    ...
                                    <div class="d-block text-center card-footer">
                                   		<a class="btn-wide btn btn-primary" href="expediente-archivos.jsp?id=2">Regresar al expediente</a>
                                        <button class="btn-wide btn btn-success">Guardar</button>
                                        <a onClick="limpiarCampos()" class="btn-wide btn btn-danger" style="color:#ffffff;">Cancelar</a>
                                    </div>
                                </form>
                    ...
                    <%
                    	...
                    	ArrayList<ObjetivoSyllabus> listObjetivo = new ArrayList<ObjetivoSyllabus>();
                    	listObjetivo = dtos.listarObjetivos(idsyllabus);
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Objetivos de asignatura</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        	<%
                                        		for(ObjetivoSyllabus os : listObjetivo){
                                        	%>
                                        		<tr>
                                        			<td><%=os.getObjetivo()%></td>
                                        			<td>
	                                        			<span title= "Editar objetivo">
	                                        				<a onClick="editarObjetivo('<%=os.getId_syllabus()%>','<%=os.getObjetivo()%>','<%=os.getId_objetivo()%>')"><i class="fas fa-edit" style= "color:blue;"></i></a>
	                                        			</span>
	                                        			<span title= "Eliminar Objetivo">
	                                        				<a onClick="eliminarObjetivo('<%=os.getId_objetivo()%>','<%=os.getId_syllabus()%>')"><i class="fas fa-trash" style= "color:red;"></i></a>
	                                        			</span>
                                        			</td>
                                        		</tr>
                                        	<%
