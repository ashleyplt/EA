...
<head>
    ...
    <title>Ver carreras activas</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Vista de las carreras activas
                                    <div class="page-title-subheading">Esta es la vista completa de las carreras actualmente activas
                                    </div>
                                </div>
                            </div>
                        </div>
