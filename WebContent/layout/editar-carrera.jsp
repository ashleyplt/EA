...
<body>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
		...
		Cr = dtc.recuperarCarrera(Integer.parseInt(idCarrera));
		%>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Formulario de edición de carrera
                                    <div class="page-title-subheading">Edite los datos de la carrera
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                <div class="card-header">Editar carrera
                                ...
                                <form action="../SLCarrera?idcarrera=<%=idCarrera%>" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionCarrera" value="2">
                                <input hidden="true"  name="estado" value="<%=Cr.getEstado()%>">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label>Nombre de la carrera</label>
                                            <input type="text" name="nombre" value="<%=Cr.getNombre()%>" class="form-control " style="width: 100%;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2"   name="id_facultad" data-placeholder="Seleccione una Facultad" style="width: 100%;" required>
												...
												for (Facultad f : listFacultad) {
													if(f.getId_facultad()==Cr.getId_facultad()){
												%>
												<option selected value="<%=f.getId_facultad()%>"><%=f.getNombre()%></option>
												<%
													}else{
												%>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select2"   name="id_departamento" data-placeholder="Seleccione una Facultad" style="width: 100%;" required>
                                                <option value=""> Selecione al menos uno</option>
                                                <%
												for (Departamento d : listDepartamento) {
													if(d.getId()==Cr.getId_departamento()){
												%>
												<option selected value="<%=d.getId()%>"><%=d.getNombre()%></option>
												<%
													}else{
												%>
