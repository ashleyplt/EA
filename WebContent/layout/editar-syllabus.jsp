...
<title>Edición de syllabus</title>
<meta name="viewport"
...
<body>
	...
	<div
		...
		<%
		int id_syllabus = Integer.parseInt(request.getParameter("idSyllabus"));
		...
		s = dts.buscarSyllabus(id_syllabus);
		%>
					...
					<div class="app-page-title">
						<div class="page-title-wrapper">
							...
							<div class="page-title-heading">
								...
								<div>
									Editar Syllabus
									<div class="page-title-subheading">Edite los datos que se le piden</div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="main-card  card">
								...
								<form action="../SLSyllabus" method="post" class="needs-validation" novalidate>
								 <input hidden="true"  id="id_syllabus" name="id_syllabus" value="<%=s.getId_syllabus()%>">
								 <input hidden="true"  id="opcionSyllabus" name="opcionSyllabus" value="2">
								 <input hidden="true"  id="id_expediente" name="id_expediente" value="<%=s.getId_expediente_asignatura()%>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2"   name="id_carrera" data-placeholder="Seleccione una Facultad" style="width: 100%;" required>
												...
												for (Carrera c : listCarrera) {
													if(c.getId_carrera()==s.getId_carrera()){
												%>
