...
<head>
    ...
    <title>Vista Maestra de carreras</title>
...
<body>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Vista maestra de carreras
                                    <div class="page-title-subheading">Esta es la vista completa de las carreras
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        	...
                                        	<%
                                        	DTVCarreraFacultad dtscf = new DTVCarreraFacultad();
    										ArrayList<VW_CarreraFacultad> listaCarreraFacultad = new ArrayList<VW_CarreraFacultad>();
    										int vistaCompleta = 1;
    										listaCarreraFacultad = dtscf.listarCarrerasFacultades(vistaCompleta);
    										
											for (VW_CarreraFacultad vcf: listaCarreraFacultad){
											...
											%>
                                            <tr class="<%=estado%>">
                                            	<td><%=vcf.getCarrera()%></td>
                                            	<td><%=vcf.getDepartamento()%></td>
                                            	<td><%=vcf.getFacultad()%></td>
                                            	<td>
                                            	<span title="Editar"> 
                                            	<a 
                                            		href="editar-carrera.jsp?idcarrera=<%=vcf.getId_carrera()%>"> 
                                            		<i class="fas fa-edit" style="color:blue;"></i>
												</a>
												</span> 
												
												<span title="<%=titleEstado%>">
													<a onclick="carreraEliminada('<%=vcf.getId_carrera()%>', '<%=vcf.getEstado()%>')">
   ...
   <!-- inicializar tabla -->
	...
	function carreraEliminada(id_carrera, estado)
	{
		window.location.href="../SLEliminarCarrera?id_carrera="+id_carrera+"&estado="+estado;
		location.reload
