						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Lista de Opciones</h3>
								</div>
								...
								<div class="card-body">
			                        ...
			                        %>
											<tr class="<%=estado%>">
												<td><%=o.getId_opcion()%></td>
												<td><%=o.getNombre()%></td>
												<td><%=o.getDescripcion()%></td>
												<td><%=o.getEstado()%></td>
												<td><span title="Editar"> <a
														href="editar-actividad.jsp?idopcion=<%=o.getId_opcion()%>">
															<i class="fas fa-edit"></i>
													</a>
												</span> <span title="<%=titleEstado%>"> <a
														href="../SLactividad?idopcion=<%=o.getId_opcion()%>&estado=<%=o.getEstado()%>">
