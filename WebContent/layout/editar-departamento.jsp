...
<body>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
		...
		d = dtd.recuperarDepartamento(Integer.parseInt(idDepartamento));
		%>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                ...
                                <form action="../SLDepartamento?iddepartamento=<%=idDepartamento%>" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionDepartamento" value="2">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label>Nombre del departamento</label>
                                            <input type="text" name="nombre" value="<%=d.getNombre()%>" class="form-control " style="width: 100%;"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="descripcion" value="<%=d.getDescripcion()%>" class="form-control " style="width: 100%;"
                                                id="validationCustomUsername" placeholder="Escriba la descripcion del departamento a registrar" required>
                                            <div class="valid-feedback">
                                                Descripcion valida
                                            </div>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2"   name="id_facultad" data-placeholder="Seleccione una Facultad" style="width: 100%;" required>
												...
												for (Facultad f : listFacultad) {
													if(f.getId_facultad()==d.getId_facultad()){
												%>
