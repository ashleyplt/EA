...
<head>
    ...
    <title>Registrar nueva coordinacion</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Formularios de registro de coordinacion
                                    <div class="page-title-subheading">Ingrese los datos de la nueva coordinacion
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                <div class="card-header">Nueva coordinacion
                                ...
                                <form action="../SLCoordinacion" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionCoordinacion" value="1">
                                    ...
                                    <div class="col-md-12 mt-2">
                                     ...
                                     <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telefono" class="form-control " style="width: 100%;"
