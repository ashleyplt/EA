                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        	...
                                        	<%
                                        	DTVDepartamentoFacultad dtsdf = new DTVDepartamentoFacultad();
                                        	ArrayList<VW_DepartamentoFacultad> listaDepartamentoFacultad = new ArrayList<VW_DepartamentoFacultad>();
                                        	listaDepartamentoFacultad = dtsdf.listarDepartamentoFacultades();
                                   
											for (VW_DepartamentoFacultad vdf: listaDepartamentoFacultad){
											%>
                                            <tr>
                                            	<td><%=vdf.getDepartamento()%></td>
                                            	<td><%=vdf.getFacultad()%></td>
                                            	<td><%=vdf.getDescripcion()%></td>
                                            	<td>
                                            	<span title="Editar"> 
                                            	<a 
                                            		href="editar-departamento.jsp?iddepartamento=<%=vdf.getId_departamento()%>"> 
