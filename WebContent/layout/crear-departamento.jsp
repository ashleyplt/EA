                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Formularios de registro de departamento
                                    <div class="page-title-subheading">Ingrese los datos del nuevo departamento
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card  card">
                                <div class="card-header">Nueva departamento
                                ...
                                <form action="../SLDepartamento" method="post" class="needs-validation" novalidate>
                                <input hidden="true"  name="opcionDepartamento" value="1">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label>Nombre del departamento</label>
                                            <input type="text" name="nombre" class="form-control " style="width: 100%;"
                                                id="validationCustomUsername" placeholder="Escriba el nombre del departamento a registrar" required>
                                     ...
                                     <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="descripcion" class="form-control " style="width: 100%;"
