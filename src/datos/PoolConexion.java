	...
	/*
        ...
        try{
	    	...
	    	if(con!=null){
	    		...
	    		JOptionPane.showMessageDialog(null, "Error al intentar conectarse a la bd : " +db);
	    		System.out.println("Error al intentar conectarse a la " +db );
	    	}
        }
            ...
            try {
               con.close();
               if ((con==null) || (con.isClosed())) {
            	   JOptionPane.showMessageDialog(null, "Se desconecto de la "+db);
            	   System.out.println("Se desconecto de la bd ExpedienteAsignatura!");
               }
               else {
            	   JOptionPane.showMessageDialog(null, "Sigue conectado a la " +db);
            	   System.out.println("Sigue conectado a la " +db);
               }
            } 
